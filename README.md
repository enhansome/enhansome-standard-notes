...
Please take a look at the [contribution guidelines](CONTRIBUTING.md) before suggesting any changes. You can also have your extension hosted by the [official plugins directory](https://github.com/standardnotes/plugins) ⭐ 120 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-05.
...
* [Music Editor](https://github.com/TheodoreChu/music-editor) ⚠️ Archived - Write music with [VexTab](https://github.com/0xfe/vextab) ⭐ 650 | 🐛 67 | 🌐 JavaScript | 📅 2026-04-15 and [VexFlow](https://github.com/0xfe/vexflow) ⭐ 4,365 | 🐛 52 | 🌐 TypeScript | 📅 2025-03-05.
...
* [Yarle - The ultimate converter of Evernote notes to Markdown](https://github.com/akosbalasko/yarle) ⭐ 1,794 | 🐛 85 | 🌐 TypeScript | 📅 2026-03-31 - A fully configurable cross-platform desktop application to convert your Evernote notebooks (enex files) to Markdown format.
* [evernote2md](https://github.com/wormi4ok/evernote2md) ⭐ 1,107 | 🐛 19 | 🌐 Go | 📅 2026-07-03 - Evernote2md is a CLI tool to convert Evernote notes exported in \*.enex format to a directory with markdown files.
...
* [Iridium](https://github.com/standardnotes/forum/issues/1135) ⭐ 219 | 🐛 613 | 📅 2023-09-30 - A local-first client written in Rust and GTK, with support for any server and offline editing <sub><sup>([SN version 003 only](VERSIONS.md "Not compatible with version 004 accounts: those created or upgraded after Nov 2020"))</sub></sup>
