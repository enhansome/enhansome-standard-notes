...
* [Music Editor](https://github.com/TheodoreChu/music-editor) ⚠️ Archived - Write music with [VexTab](https://github.com/0xfe/vextab) ⭐ 651 | 🐛 67 | 🌐 JavaScript | 📅 2026-04-15 and [VexFlow](https://github.com/0xfe/vexflow) ⭐ 4,369 | 🐛 52 | 🌐 TypeScript | 📅 2025-03-05.
...
* [sn-cli](https://github.com/jonhadfield/sn-cli) ⭐ 94 | 🐛 6 | 🌐 Go | 📅 2026-09-07 - Manage notes, tags, and other account operations
...
* [Yarle - The ultimate converter of Evernote notes to Markdown](https://github.com/akosbalasko/yarle) ⭐ 1,803 | 🐛 85 | 🌐 TypeScript | 📅 2026-03-31 - A fully configurable cross-platform desktop application to convert your Evernote notebooks (enex files) to Markdown format.
...
* [gosn-v2](https://github.com/jonhadfield/gosn-v2) ⭐ 18 | 🐛 3 | 🌐 Go | 📅 2026-09-05 - A library written in Go
...
* [Iridium](https://github.com/standardnotes/forum/issues/1135) ⭐ 220 | 🐛 619 | 📅 2023-09-30 - A local-first client written in Rust and GTK, with support for any server and offline editing <sub><sup>([SN version 003 only](VERSIONS.md "Not compatible with version 004 accounts: those created or upgraded after Nov 2020"))</sub></sup>
