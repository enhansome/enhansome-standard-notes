...
* [Music Editor](https://github.com/TheodoreChu/music-editor) ⚠️ Archived - Write music with [VexTab](https://github.com/0xfe/vextab) ⭐ 652 | 🐛 67 | 🌐 JavaScript | 📅 2026-04-15 and [VexFlow](https://github.com/0xfe/vexflow) ⭐ 4,378 | 🐛 52 | 🌐 TypeScript | 📅 2025-03-05.
...
* [sn-dotfiles](https://github.com/jonhadfield/sn-dotfiles) ⭐ 27 | 🐛 5 | 🌐 Go | 📅 2026-09-14 - Sync and manage dotfiles using Standard Notes
