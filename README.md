...
* [Tui Markdown Editor](https://github.com/MortalHappiness/sn-tui.editor) ⚠️ Archived - A markdown editor using [Toast UI Markdown Editor](https://github.com/nhn/tui.editor) ⭐ 18,012 | 🐛 643 | 🌐 TypeScript | 📅 2024-08-01.
...
* [Yarle - The ultimate converter of Evernote notes to Markdown](https://github.com/akosbalasko/yarle) ⭐ 1,790 | 🐛 85 | 🌐 TypeScript | 📅 2026-03-31 - A fully configurable cross-platform desktop application to convert your Evernote notebooks (enex files) to Markdown format.
* [evernote2md](https://github.com/wormi4ok/evernote2md) ⭐ 1,104 | 🐛 19 | 🌐 Go | 📅 2026-07-03 - Evernote2md is a CLI tool to convert Evernote notes exported in \*.enex format to a directory with markdown files.
...
* [Iridium](https://github.com/standardnotes/forum/issues/1135) ⭐ 219 | 🐛 609 | 📅 2023-09-30 - A local-first client written in Rust and GTK, with support for any server and offline editing <sub><sup>([SN version 003 only](VERSIONS.md "Not compatible with version 004 accounts: those created or upgraded after Nov 2020"))</sub></sup>
