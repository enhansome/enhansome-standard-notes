...
Please take a look at the [contribution guidelines](CONTRIBUTING.md) before suggesting any changes. You can also have your extension hosted by the [official plugins directory](https://github.com/standardnotes/plugins) ⭐ 119 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-05.
...
* [Cosmos](https://github.com/nienow/cosmos) ⭐ 19 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-01 - Split a note into multiple areas. Each area can use a different editor. Install new editors more easily.
...
* [Music Editor](https://github.com/TheodoreChu/music-editor) ⚠️ Archived - Write music with [VexTab](https://github.com/0xfe/vextab) ⭐ 650 | 🐛 67 | 🌐 JavaScript | 📅 2026-04-15 and [VexFlow](https://github.com/0xfe/vexflow) ⭐ 4,364 | 🐛 52 | 🌐 TypeScript | 📅 2025-03-05.
...
* [Tui Markdown Editor](https://github.com/MortalHappiness/sn-tui.editor) ⚠️ Archived - A markdown editor using [Toast UI Markdown Editor](https://github.com/nhn/tui.editor) ⭐ 18,008 | 🐛 643 | 🌐 TypeScript | 📅 2024-08-01.
...
* [sn-dotfiles](https://github.com/jonhadfield/sn-dotfiles) ⭐ 27 | 🐛 3 | 🌐 Go | 📅 2023-03-06 - Sync and manage dotfiles using Standard Notes

### Importers, Exporters, and Converters

* [Yarle - The ultimate converter of Evernote notes to Markdown](https://github.com/akosbalasko/yarle) ⭐ 1,793 | 🐛 85 | 🌐 TypeScript | 📅 2026-03-31 - A fully configurable cross-platform desktop application to convert your Evernote notebooks (enex files) to Markdown format.
* [evernote2md](https://github.com/wormi4ok/evernote2md) ⭐ 1,106 | 🐛 19 | 🌐 Go | 📅 2026-07-03 - Evernote2md is a CLI tool to convert Evernote notes exported in \*.enex format to a directory with markdown files.
...
* [gosn-v2](https://github.com/jonhadfield/gosn-v2) ⭐ 18 | 🐛 4 | 🌐 Go | 📅 2026-06-29 - A library written in Go
...
* [Iridium](https://github.com/standardnotes/forum/issues/1135) ⭐ 219 | 🐛 611 | 📅 2023-09-30 - A local-first client written in Rust and GTK, with support for any server and offline editing <sub><sup>([SN version 003 only](VERSIONS.md "Not compatible with version 004 accounts: those created or upgraded after Nov 2020"))</sub></sup>
